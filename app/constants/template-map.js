const {
  ...
  DUPLICATE_PAYMENT: DUPLICATE_PAYMENT_EVENT,
  ...
  EVENT_SAVE_ALERT: EVENT_SAVE_ALERT_EVENT,
  TABLE_CREATE_ALERT: TABLE_CREATE_ALERT_EVENT,
  RESPONSES_PROCESSING_FAILED: RESPONSES_PROCESSING_FAILED_EVENT,
  CUSTOMER_UPDATE_PROCESSING_FAILED: CUSTOMER_UPDATE_PROCESSING_FAILED_EVENT,
  TRACKING_UPDATE_FAILURE: TRACKING_UPDATE_FAILURE_EVENT
} = require('./events')

const {
  BATCH_REJECTED: BATCH_REJECTED_TEMPLATE,
  BATCH_QUARANTINED: BATCH_QUARANTINED_TEMPLATE,
  DUPLICATE_PAYMENT: DUPLICATE_PAYMENT_TEMPLATE,
  ...
  EVENT_SAVE_ALERT: EVENT_SAVE_ALERT_TEMPLATE,
  TABLE_CREATE_ALERT: TABLE_CREATE_ALERT_TEMPLATE,
  RESPONSES_PROCESSING_FAILED: RESPONSES_PROCESSING_FAILED_TEMPLATE,
  CUSTOMER_UPDATE_PROCESSING_FAILED: CUSTOMER_UPDATE_PROCESSING_FAILED_TEMPLATE,
  TRACKING_UPDATE_FAILURE: TRACKING_UPDATE_FAILURE_TEMPLATE
} = require('./templates')

module.exports = {
  [BATCH_REJECTED_EVENT]: BATCH_REJECTED_TEMPLATE,
  [BATCH_QUARANTINED_EVENT]: BATCH_QUARANTINED_TEMPLATE,
  [DUPLICATE_PAYMENT_EVENT]: DUPLICATE_PAYMENT_TEMPLATE,
  ...
  [EVENT_SAVE_ALERT_EVENT]: EVENT_SAVE_ALERT_TEMPLATE,
  [TABLE_CREATE_ALERT_EVENT]: TABLE_CREATE_ALERT_TEMPLATE,
  [RESPONSES_PROCESSING_FAILED_EVENT]: RESPONSES_PROCESSING_FAILED_TEMPLATE,
  [CUSTOMER_UPDATE_PROCESSING_FAILED_EVENT]: CUSTOMER_UPDATE_PROCESSING_FAILED_TEMPLATE,
  [TRACKING_UPDATE_FAILURE_EVENT]: TRACKING_UPDATE_FAILURE_TEMPLATE
}
